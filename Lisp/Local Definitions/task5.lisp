; Symmetric Difference in List 


(defun list-sym-difference (l1 l2)
  (defun sub (a b)
    (if a
      (if (member (car a) b)
        (sub (cdr a) b)
...
(defun my-apply (func args links)
  (cond ((atom func)
    (cond
      ...
      ((eq (car func) 'list-sym-difference) (list-sym-difference (caddr func)))
...
(print (list-sym-difference '(1 2 3 4 5 6) '(1 2 3 5 8 13))) ;4 6 8 13
